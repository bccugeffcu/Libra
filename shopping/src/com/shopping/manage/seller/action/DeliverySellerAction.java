...
public class DeliverySellerAction {
	...
	public ModelAndView delivery(HttpServletRequest request,
		...
		ModelAndView mv = new JModelAndView(
				"user/default/usercenter/delivery.html",
	...
	public ModelAndView delivery_log(HttpServletRequest request,
			...
			String orderType) {
		ModelAndView mv = new JModelAndView(
				"user/default/usercenter/delivery_log.html",
				this.configService.getSysConfig(),
				this.userConfigService.getUserConfig(), 0, request, response);
		User user = this.userService.getObjById(SecurityUserHolder
				.getCurrentUser().getId());
	...
	public ModelAndView delivery_buy(HttpServletRequest request,
		...
		ModelAndView mv = new JModelAndView(
				"user/default/usercenter/delivery_buy.html",
				this.configService.getSysConfig(),
				this.userConfigService.getUserConfig(), 0, request, response);
		User user = this.userService.getObjById(SecurityUserHolder
				.getCurrentUser().getId());
	...
	public ModelAndView delivery_apply(HttpServletRequest request,
		...
		ModelAndView mv = new JModelAndView(
				"user/default/usercenter/delivery_apply.html",
				this.configService.getSysConfig(),
				this.userConfigService.getUserConfig(), 0, request, response);
		User user = this.userService.getObjById(SecurityUserHolder
				.getCurrentUser().getId());
		...
		Map map = CommUtil.cal_time_space(new Date(),
				store.getDelivery_begin_time());
	...
	public ModelAndView delivery_goods(HttpServletRequest request,
		...
		ModelAndView mv = new JModelAndView(
				"user/default/usercenter/delivery_goods.html",
				this.configService.getSysConfig(),
				this.userConfigService.getUserConfig(), 0, request, response);
		User user = this.userService.getObjById(SecurityUserHolder
				.getCurrentUser().getId());
		...
		qo.addQuery("obj.delivery_status", new SysMap("delivery_status",
				Integer.valueOf(0)), "=");
		...
		qo.addQuery("obj.goods_status",
				new SysMap("goods_status", Integer.valueOf(0)), "=");
		qo.addQuery("obj.group_buy",
				new SysMap("group_buy", Integer.valueOf(0)), "=");
		qo.addQuery("obj.activity_status", new SysMap("activity_status",
				Integer.valueOf(0)), "=");
	...
	public ModelAndView delivery_apply_save(HttpServletRequest request,
		...
		if ((!delivery_session1.equals(""))
			...
			DeliveryGoods obj = (DeliveryGoods) wf.toPo(request,
					DeliveryGoods.class);
