...
public class ReportBuyerAction {
	...
	public ModelAndView report(HttpServletRequest request,
		...
		ModelAndView mv = new JModelAndView(
				"user/default/usercenter/report.html",
	...
	public ModelAndView report_add(HttpServletRequest request,
		...
		ModelAndView mv = new JModelAndView(
				"user/default/usercenter/report_add.html",
				this.configService.getSysConfig(),
				this.userConfigService.getUserConfig(), 0, request, response);
		...
		if (user.getReport() == -1) {
			...
			if (reports.size() == 0) {
				...
				List types = this.reportTypeService
						.query("select obj from ReportType obj order by obj.addTime desc",
								null, -1, -1);
	...
	public ModelAndView report_view(HttpServletRequest request,
		...
		ModelAndView mv = new JModelAndView(
				"user/default/usercenter/report_view.html",
				this.configService.getSysConfig(),
				this.userConfigService.getUserConfig(), 0, request, response);
