...
public class RSA {
	 ...
	 * @return 签名值
	 */
	public static String signWap(String content, String privateKey,
			String input_charset) {
		try {
			PKCS8EncodedKeySpec priPKCS8 = new PKCS8EncodedKeySpec(
					Base64Wap.decode(privateKey));
	 ...
	 * @return 布尔值
	 */
	public static boolean verifyWap(String content, String sign,
			String ali_public_key, String input_charset) {
		try {
			KeyFactory keyFactory = KeyFactory.getInstance("RSA");
			byte[] encodedKey = Base64Wap.decode(ali_public_key);
	 ...
	 * @return 解密后的字符串
	 */
	public static String decryptWap(String content, String private_key,
			String input_charset) throws Exception {
