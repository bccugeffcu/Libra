...
public class UCViewAction {
	...
	protected void shopping_login(HttpServletRequest request,
	...
	protected void shopping_logout(HttpServletRequest request,
			HttpServletResponse response, Map<String, String> args) {
	...
	protected void shopping_update_pws(HttpServletRequest request,
			HttpServletResponse response, Map<String, String> args) {
