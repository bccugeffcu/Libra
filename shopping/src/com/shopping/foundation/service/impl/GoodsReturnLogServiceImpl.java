...
public class GoodsReturnLogServiceImpl implements IGoodsReturnLogService {
	...
	public GoodsReturnLog getObjById(Long id) {
		GoodsReturnLog goodsReturnLog = (GoodsReturnLog) this.goodsReturnLogDao
				.get(id);
	...
	public IPageList list(IQueryObject properties) {
		...
		GenericPageList pList = new GenericPageList(GoodsReturnLog.class,
				query, params, this.goodsReturnLogDao);
		if (properties != null) {
	...
	public List<GoodsReturnLog> query(String query, Map params, int begin,
			int max) {
