...
@Service
@Transactional
public class GoodsSpecificationServiceImpl implements
		IGoodsSpecificationService {
	...
	public IPageList list(IQueryObject properties) {
		...
		GenericPageList pList = new GenericPageList(GoodsSpecification.class,
				query, params, this.goodsSpecificationDao);
		if (properties != null) {
	...
	public List<GoodsSpecification> query(String query, Map params, int begin,
			int max) {
