...
public class UserGoodsClassServiceImpl implements IUserGoodsClassService {
	...
	public UserGoodsClass getObjById(Long id) {
		UserGoodsClass userGoodsClass = (UserGoodsClass) this.userGoodsClassDao
				.get(id);
	...
	public IPageList list(IQueryObject properties) {
		...
		GenericPageList pList = new GenericPageList(UserGoodsClass.class,
				query, params, this.userGoodsClassDao);
		if (properties != null) {
	...
	public List<UserGoodsClass> query(String query, Map params, int begin,
			int max) {
