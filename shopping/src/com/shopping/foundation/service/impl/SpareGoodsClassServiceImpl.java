...
public class SpareGoodsClassServiceImpl implements ISpareGoodsClassService {
	...
	public SpareGoodsClass getObjById(Long id) {
		SpareGoodsClass spareGoodsClass = (SpareGoodsClass) this.spareGoodsClassDao
				.get(id);
	...
	public IPageList list(IQueryObject properties) {
		...
		GenericPageList pList = new GenericPageList(SpareGoodsClass.class,
				query, params, this.spareGoodsClassDao);
		if (properties != null) {
	...
	public List<SpareGoodsClass> query(String query, Map params, int begin,
			int max) {
