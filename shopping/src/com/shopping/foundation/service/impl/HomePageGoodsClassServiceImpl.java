...
public class HomePageGoodsClassServiceImpl implements
	...
	public IPageList list(IQueryObject properties) {
		...
		GenericPageList pList = new GenericPageList(HomePageGoodsClass.class,
				query, params, this.homePageGoodsClassDao);
		if (properties != null) {
	...
	public List<HomePageGoodsClass> query(String query, Map params, int begin,
			int max) {
