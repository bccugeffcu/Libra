...
public class GoodsReturnItemServiceImpl implements IGoodsReturnItemService {
	...
	public GoodsReturnItem getObjById(Long id) {
		GoodsReturnItem goodsReturnItem = (GoodsReturnItem) this.goodsReturnItemDao
				.get(id);
	...
	public IPageList list(IQueryObject properties) {
		...
		GenericPageList pList = new GenericPageList(GoodsReturnItem.class,
				query, params, this.goodsReturnItemDao);
		if (properties != null) {
	...
	public List<GoodsReturnItem> query(String query, Map params, int begin,
			int max) {
