...
public class IntegralGoodsOrderServiceImpl implements
	...
	public IPageList list(IQueryObject properties) {
		...
		GenericPageList pList = new GenericPageList(IntegralGoodsOrder.class,
				query, params, this.integralGoodsOrderDao);
		if (properties != null) {
	...
	public List<IntegralGoodsOrder> query(String query, Map params, int begin,
			int max) {
