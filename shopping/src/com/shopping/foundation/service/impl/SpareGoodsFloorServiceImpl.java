...
public class SpareGoodsFloorServiceImpl implements ISpareGoodsFloorService {
	...
	public SpareGoodsFloor getObjById(Long id) {
		SpareGoodsFloor spareGoodsFloor = (SpareGoodsFloor) this.spareGoodsFloorDao
				.get(id);
	...
	public IPageList list(IQueryObject properties) {
		...
		GenericPageList pList = new GenericPageList(SpareGoodsFloor.class,
				query, params, this.spareGoodsFloorDao);
		if (properties != null) {
	...
	public List<SpareGoodsFloor> query(String query, Map params, int begin,
			int max) {
