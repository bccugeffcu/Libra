...
public class ChattingFriendServiceImpl implements IChattingFriendService {
	...
	public ChattingFriend getObjById(Long id) {
		ChattingFriend chattingFriend = (ChattingFriend) this.chattingFriendDao
				.get(id);
	...
	public IPageList list(IQueryObject properties) {
		...
		GenericPageList pList = new GenericPageList(ChattingFriend.class,
				query, params, this.chattingFriendDao);
		if (properties != null) {
	...
	public List<ChattingFriend> query(String query, Map params, int begin,
			int max) {
