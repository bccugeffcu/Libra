...
public class StoreNavigationServiceImpl implements IStoreNavigationService {
	...
	public StoreNavigation getObjById(Long id) {
		StoreNavigation storeNavigation = (StoreNavigation) this.storeNavigationDao
				.get(id);
	...
	public IPageList list(IQueryObject properties) {
		...
		GenericPageList pList = new GenericPageList(StoreNavigation.class,
				query, params, this.storeNavigationDao);
		if (properties != null) {
	...
	public List<StoreNavigation> query(String query, Map params, int begin,
			int max) {
