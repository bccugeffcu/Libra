...
public class GoodsTypePropertyServiceImpl implements IGoodsTypePropertyService {
	...
	public GoodsTypeProperty getObjById(Long id) {
		GoodsTypeProperty goodsTypeProperty = (GoodsTypeProperty) this.goodsTypePropertyDao
				.get(id);
	...
	public IPageList list(IQueryObject properties) {
		...
		GenericPageList pList = new GenericPageList(GoodsTypeProperty.class,
				query, params, this.goodsTypePropertyDao);
		if (properties != null) {
	...
	public List<GoodsTypeProperty> query(String query, Map params, int begin,
			int max) {
