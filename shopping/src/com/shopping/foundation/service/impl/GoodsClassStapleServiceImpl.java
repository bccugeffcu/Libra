...
public class GoodsClassStapleServiceImpl implements IGoodsClassStapleService {
	...
	public GoodsClassStaple getObjById(Long id) {
		GoodsClassStaple goodsClassStaple = (GoodsClassStaple) this.goodsClassStapleDao
				.get(id);
	...
	public IPageList list(IQueryObject properties) {
		...
		GenericPageList pList = new GenericPageList(GoodsClassStaple.class,
				query, params, this.goodsClassStapleDao);
		if (properties != null) {
	...
	public List<GoodsClassStaple> query(String query, Map params, int begin,
			int max) {
