...
public class MobileVerifyCodeServiceImpl implements IMobileVerifyCodeService {
	...
	public MobileVerifyCode getObjById(Long id) {
		MobileVerifyCode mobileVerifyCode = (MobileVerifyCode) this.mobileVerifyCodeDao
				.get(id);
	...
	public IPageList list(IQueryObject properties) {
		...
		GenericPageList pList = new GenericPageList(MobileVerifyCode.class,
				query, params, this.mobileVerifyCodeDao);
		if (properties != null) {
	...
	public List<MobileVerifyCode> query(String query, Map params, int begin,
			int max) {
	...
	public MobileVerifyCode getObjByProperty(String propertyName, Object value) {
		return (MobileVerifyCode) this.mobileVerifyCodeDao.getBy(propertyName,
				value);
	}
}
