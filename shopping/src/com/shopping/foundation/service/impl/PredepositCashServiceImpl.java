...
public class PredepositCashServiceImpl implements IPredepositCashService {
	...
	public PredepositCash getObjById(Long id) {
		PredepositCash predepositCash = (PredepositCash) this.predepositCashDao
				.get(id);
	...
	public IPageList list(IQueryObject properties) {
		...
		GenericPageList pList = new GenericPageList(PredepositCash.class,
				query, params, this.predepositCashDao);
		if (properties != null) {
	...
	public List<PredepositCash> query(String query, Map params, int begin,
			int max) {
