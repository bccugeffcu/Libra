...
public class GoodsSpecPropertyServiceImpl implements IGoodsSpecPropertyService {
	...
	public GoodsSpecProperty getObjById(Long id) {
		GoodsSpecProperty goodsSpecProperty = (GoodsSpecProperty) this.goodsSpecPropertyDao
				.get(id);
	...
	public IPageList list(IQueryObject properties) {
		...
		GenericPageList pList = new GenericPageList(GoodsSpecProperty.class,
				query, params, this.goodsSpecPropertyDao);
		if (properties != null) {
	...
	public List<GoodsSpecProperty> query(String query, Map params, int begin,
			int max) {
