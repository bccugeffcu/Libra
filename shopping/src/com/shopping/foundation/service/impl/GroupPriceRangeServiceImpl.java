...
public class GroupPriceRangeServiceImpl implements IGroupPriceRangeService {
	...
	public GroupPriceRange getObjById(Long id) {
		GroupPriceRange groupPriceRange = (GroupPriceRange) this.groupPriceRangeDao
				.get(id);
	...
	public IPageList list(IQueryObject properties) {
		...
		GenericPageList pList = new GenericPageList(GroupPriceRange.class,
				query, params, this.groupPriceRangeDao);
		if (properties != null) {
	...
	public List<GroupPriceRange> query(String query, Map params, int begin,
			int max) {
