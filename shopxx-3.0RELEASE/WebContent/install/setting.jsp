			...
			<div class="bodyRight">
				<table>
					...
					<tr>
						<td>数据库用户名:</td>
						<td>
							<input type="text" id="databaseUsername" name="databaseUsername" class="text" value="root" maxlength="200" />
							<span class="requireField">*</span>
						</td>
					</tr>
					<tr>
						<td>数据库密码:</td>
						<td>
							<input type="password" id="databasePassword" name="databasePassword" value="qing" class="text" maxlength="200" />
						</td>
					</tr>
					<tr>
						<td>数据库名称:</td>
						<td>
							<input type="text" id="databaseName" name="databaseName" class="text" value="shopxx3" maxlength="200" />
							<span class="requireField">*</span>
						</td>
					</tr>
				</table>
				<table>
					...
					<tr>
						<td>密码:</td>
						<td>
							<input type="password" id="adminPassword" name="adminPassword" value="admin" class="text" maxlength="20" />
							<span class="requireField">*</span>
						</td>
					</tr>
					<tr>
						<td>重复密码:</td>
						<td>
							<input type="password" id="reAdminPassword" name="reAdminPassword" value="admin"  class="text" maxlength="20" />
							<span class="requireField">*</span>
						</td>
					</tr>
				</table>
				<table>
					...
					<tr>
						...
						<td>
							<input type="checkbox" id="isCreateDatabase" name="isCreateDatabase" value="true"  />
						</td>
					</tr>
					<tr>
						<td>初始化DEMO数据:</td>
						<td>
							<input type="checkbox" id="isInitializeDemo" name="isInitializeDemo" value="true" />
						</td>
					</tr>
				</table>
			</div>
